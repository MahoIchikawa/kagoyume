...
const CART = 'cart.php';                          //cart
const BUY_CONF = 'buy_confirm.php';               //buy confirm
const BUY_COMP = 'buy_complete.php';              //buy complete
const MY_DATA = 'my_data.php';                    //data
const HISTORY = 'my_history.php';                 //history
const UPDATE = 'my_update.php';                   //update
const UPDATE_RESULT = 'my_update_result.php';    //update result
